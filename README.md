...
| **Notifications** | NotifierEmail      | [`{}`](https://ubivar.com/docs/python#create_notifieremails)| [`123`](https://ubivar.com/docs/python#retrieve_notifieremails) | [`123, {}`](https://ubivar.com/docs/python#update_notifieremails) | [`123`](https://ubivar.com/docs/python#delete_notifieremails) | [`{}`](https://ubivar.com/docs/python#list_notifieremails) | | 
